...
router.post('/' , (req,res) => {
    ...
    checkValidity(contact).then(()=>{
        db.query("INSERT INTO contact VALUES ($1,$2,$3,$4,$5,$6);",[contact.id,contact.first_name,contact.last_name,contact.email,contact.phone_number,contact.users_contact]).then(data=>{
...
let checkValidity = function (contact){
    return new Promise((resolve,reject) => {
        if(contact.id && contact.phone_number&&contact.first_name&&contact.last_name&&contact.email&&contact.users_contact){
